    ...
    <div class="container">
        ...
        <div class="row">
                        <div class="col-md-7 col-sm-7 col-xs-12">
                            <div class="content">
                                <h3><b>Launch Your Brand With Us.</b></h3><br>
                                ...
                                <p class="text-justify">In order to help organizations and the people who are dedicated for those startup businesses, our professional consultants offer unique expertise that combines diverse entrepreneurial experiences, real business insights along with the practical solutions.
</p>
                                <p class="text-justify">It is always recommended to seek professional business advice and support for a stress free starting of your business. Generally, our founder works directly with each one of our clients and helps them identifying the most critical procedures while providing resolutions for them to get them executed properly. Our consultants or the founder will be able to answer every single question clients have, and also can advise them for a greater return on investment accordingly.</p>
                            </div>
                        </div>
                        <div class="col-md-5 col-sm-5 col-xs-12">
                            <div class="img-box">
                                <img src="images/services/start-up.jpg" alt="">
                            </div>
                        </div>
        </div>
