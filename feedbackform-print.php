...
include "connection.php";
  ...
  $academicQuery = mysqli_query($conn, $sql);
    ...
    if($records !=null){
        $patientname = $records['fname'];
        $age = $records['age'];
        $phone = $records['phone'];
        $place = $records['place'];
        $findus = $records['findus'];
        $experience = $records['experience'];
        $suggestions = $records['suggestions'];
    ...
    $output.='<p style="font-size: 17px; margin-left:10px">Name: <b><u>'.$patientname.'</u></b>  Age: <b><u>'.$age.'</b></u></p>';
    $output.='<p style="font-size: 17px;font-weight:200; margin-left:10px;margin-top:10px">Phone:  <b><u>'.$phone.'</u></b>  Place: <b><u>'.$place.'</u></b></p>';
    $output .=$column;
    $output.='<p style="font-size: 16px;font-weight:200; margin-left:10px;margin-top:20px">Where did you find us:  <b><u>'.$findus.'</u></b></p>';
    $output.='<p style="font-size: 16px;font-weight:200; margin-left:10px;margin-top:20px">Overall Experience:  <b><u>'.$experience.'</u></b></p>';
    $output.='<p style="font-size: 16px;font-weight:200; margin-left:10px;margin-top:20px">Any Other Suggestions:  <b><u>'.$suggestions.'</u></b></p>';
    return $output;
}
